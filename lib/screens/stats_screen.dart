...
class _StatsScreenState extends State<StatsScreen> {
                  ...
                  if (totalExpense > 0) ...[
                      Padding(
                        ...
                        child: Align(
                            ...
                            child: Text('Cơ cấu chi tiêu', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold))
                        ),
                      ),
                      const SizedBox(height: 16),
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text('Tổng chi', style: TextStyle(fontSize: 12, color: Colors.grey[600], fontWeight: FontWeight.w500)),
                                const SizedBox(height: 4),
                                Text(_formatCompactCurrency(totalExpense), style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.blueGrey[800])),
                              ],
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Chi tiết theo danh mục', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
  ...
  Widget _buildCashflowChart(BuildContext context, ExpenseProvider provider) {
    ...
    final daysInMonth = DateUtils.getDaysInMonth(provider.selectedMonth.year, provider.selectedMonth.month);
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Text('Dòng tiền (Thu/Chi)', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
        ),
        const SizedBox(height: 16),
        SingleChildScrollView(
          ...
          padding: const EdgeInsets.symmetric(horizontal: 16),
          child: SizedBox(
            width: chartWidth > MediaQuery.of(context).size.width - 32 ? chartWidth : MediaQuery.of(context).size.width - 32,
            height: 200,
            child: BarChart(
              BarChartData(
                ...
                titlesData: FlTitlesData(
                  ...
                  leftTitles: AxisTitles(sideTitles: SideTitles(showTitles: false)), // Hide Y Axis
                ...
                barGroups: List.generate(daysInMonth, (index) {
                   final day = index + 1;
                   final data = dailyData[day] ?? {'income': 0.0, 'expense': 0.0};
      ...
      child: Row(
        ...
        children: [
          IconButton(
            ...
            onPressed: () {
              final newMonth = DateTime(provider.selectedMonth.year, provider.selectedMonth.month - 1);
  ...
  List<PieChartSectionData> _showingSections(
    ...
    final List<Color> pastelColors = [
      const Color(0xFFFF6B9D), const Color(0xFFC44569), const Color(0xFF8E44AD),
      const Color(0xFF5F27CD), const Color(0xFF0ABDE3), const Color(0xFF00D2D3),
      const Color(0xFFFEA47F), const Color(0xFFF97F51), const Color(0xFFFFB900),
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(categoryName, style: const TextStyle(fontWeight: FontWeight.w600)),
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Text(CurrencyHelper.format(amount), style: const TextStyle(fontWeight: FontWeight.bold)),
